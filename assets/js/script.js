...
const setLetterEffect = function () {
    ...
    for (let i=0; i < letterBoxes.length; i++) {
        ...
        // get alll character from the current letter box
        ...
        for (let j = 0; j < letters.length; j++) {
            ...
            // set the "in" class on the span, if current letter box ix active
...
window.addEventListener("scroll", function () {
    ...
    // visiblle back to the top btn when scrolled 5% of the page
